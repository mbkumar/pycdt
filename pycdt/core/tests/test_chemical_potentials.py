...
class MPChemPotAnalyzerTest(unittest.TestCase):
    ...
    def test_analyze_GGA_chempots(self):
        ...
        self.assertEqual({u'Sb': -4.4526680150000004, u'As': -5.3589730550000008, u'Ga': -3.030829475,
                          u'In': -2.7215626899999998}, cp_fsaf['GaSb-Ga-In'])
        self.assertEqual({u'Sb': -4.2476110999999994, u'As': -5.1539161399999998, u'Ga': -3.235886390000001,
                          u'In': -2.7215626899999998},  cp_fsaf['InAs-GaSb-In'])
        self.assertEqual({u'Sb': -4.1243295800000004, u'As': -5.0306346200000007, u'Ga': -3.35916791,
                          u'In': -2.8448442099999989}, cp_fsaf['InAs-GaSb-Sb'])
        self.assertEqual({u'Sb': -4.1243295800000004, u'As': -4.6580705550000001, u'Ga': -3.7317319750000006,
        ...
        self.assertEqual( {u'Sb': -4.3857206700000004, u'As': -5.1539161399999998, u'Ga': -3.235886390000001,
                           u'In': -2.7215626899999998}, cp_fsat['InSb-InAs-In'])
        self.assertEqual( {u'Sb': -4.3857206700000004, u'As': -5.2920257100000008, u'Ga': -3.09777682,
                           u'In': -2.7215626899999998}, cp_fsat['InSb-GaSb-In'])
        self.assertEqual( {u'Sb': -4.1243295800000004, u'As': -4.8925250499999997, u'Ga': -3.497277480000001,
        ...
        self.assertEqual( {u'As': -4.6580705550000001, u'Ga': -3.7317319750000006}, cp_fsaf_us_ce['As_rich'])
        self.assertEqual( {u'As': -5.3589730550000008, u'Ga': -3.030829475}, cp_fsaf_us_ce['Ga_rich'])
        ...
        self.assertEqual( {u'As': -4.7203949399999985, u'Ga': -3.6694075900000023}, cp_fsaf_s_cdne['GaAs_rich'])
        self.assertEqual( {u'As': -4.6580705550000001, u'Ga': -3.7628941674999994}, cp_fsaf_s_cdne['As_rich'])
        ...
        self.assertEqual(set(['Ga-GaAs']), set(cp_fsaf_us_cdne_a.keys()))
        self.assertEqual( {u'As': -5.3589730550000008, u'Ga': -3.030829475}, cp_fsaf_us_cdne_a['Ga-GaAs'])
        ...
        self.assertEqual(set(['As-GaAs-Sb']), set(cp_fsaf_us_cdne_b.keys()))
        self.assertEqual( {u'Sb': -4.1243295800000004, u'As': -4.6580705550000001,
    ...
    def test_get_chempots_from_composition(self):
        ...
        self.assertEqual({u'Cr': -14.638073584999995, u'O': -5.5171868950000045}, cro_cp['CrO2_rich'])
        self.assertEqual({u'Cr': -9.6385552600000004, u'O': -8.850199111666667}, cro_cp['Cr_rich'])
...
class UserChemPotAnalyzerTest(unittest.TestCase):
    ...
    def test_read_phase_diagram_and_chempots(self):
        ...
        with ScratchDir('.'):
            ...
            self.assertEqual( {u'As': -5.3585191833333328, u'Ga': -4.2880321141666675}, cp['As_rich'])
            self.assertEqual( {u'As': -6.0386246900000007, u'Ga': -3.6079266075}, cp['Ga_rich'])
        ...
        with ScratchDir('.'):
            ...
            self.assertEqual( set(['As_rich', 'Ga_rich']), set(cp.keys()))
            self.assertEqual( {u'As': -5.3585191833333328, u'Ga': -4.2880321141666675}, cp['As_rich'])
            self.assertEqual( {u'As': -6.6157218225000003, u'Ga': -3.030829475}, cp['Ga_rich'])
