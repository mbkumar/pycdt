...
class FiniteSizeChargeCorrectionTest(PymatgenTest):
    ...
    def test_get_correction_freysoldt(self):
        freyout = get_correction_freysoldt( self.defect_entry, self.epsilon,
                                            title = None, partflag='All', axis=None)
        self.assertEqual( freyout, 5.445950368792991)

        freyout = get_correction_freysoldt( self.defect_entry, self.epsilon,
                                            title = None, partflag='AllSplit', axis=None)
    ...
    def test_get_correction_kumagai(self):
        kumagaiout = get_correction_kumagai( self.defect_entry, self.epsilon,
                                            title = None, partflag='AllSplit')
