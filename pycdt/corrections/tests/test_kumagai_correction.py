...
class StructureFunctionsTest(unittest.TestCase):
    ...
    def test_genrecip(self):
        brecip=[[-1.0926931033637688, 0, 0],
                [0, -1.0926931033637688, 0],
                [0, 0, -1.0926931033637688],
                [0, 0, 1.0926931033637688],
                [0, 1.0926931033637688, 0],
                [1.0926931033637688, 0, 0]]
    ...
    def test_generate_reciprocal_vectors_squared(self):
        ...
        self.assertAlmostEqual(
            generate_reciprocal_vectors_squared(self.a, self.b, self.c, 1.3),
            brecip)
    ...
    def test_find_defect_pos(self):
        #might be good to include more defect poscars to
        # test all types of defect finding..
